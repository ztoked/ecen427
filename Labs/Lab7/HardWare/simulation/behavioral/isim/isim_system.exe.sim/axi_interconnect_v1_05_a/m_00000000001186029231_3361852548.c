...
static int ng2[] = {32, 0};
static unsigned int ng3[] = {32U, 0U, 32U, 0U, 32U, 0U};
static int ng4[] = {0, 0};
...
LAB2:    xsi_set_current_line(495, ng0);
    ...
    *((unsigned int *)t13) = (t20 | t14);
    t21 = *((unsigned int *)t19);
    *((unsigned int *)t19) = (t21 | t15);
    xsi_driver_vfirst_trans(t9, 10, 14);
    t22 = (t0 + 106688);
    *((int *)t22) = 1;
